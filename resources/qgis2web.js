...
map.getView().fit([-172211.403933, 1381037.176340, -165232.108960, 1384692.652944], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WEBMAPPING_INTENSITE_URBAINE</h2>';
        return titleElement;
    })(),
